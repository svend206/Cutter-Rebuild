---
doc_id: quarantine_tests_readme
doc_type: context
status: quarantined
version: 1.0
date: 2026-01-18
...
Source: Cutter Layers/tests/README.md
...
python tests/seed_test_data.py --scenario quantity
python tests/seed_test_data.py --scenario lead
